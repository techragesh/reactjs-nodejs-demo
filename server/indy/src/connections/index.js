...
exports.prepareRequest = async function (theirEndpointDid) {
    ...
    console.log("Connections index-- prepareRequest-- theirEndpointDid-->", theirEndpointDid);
    console.log("Connections index-- prepareRequest-- myNewDid-->", myNewDid);
    console.log("Connections index-- prepareRequest-- myNewVerkey-->", myNewVerkey);
    await indy.pool.sendNym(await indy.pool.get(), await indy.wallet.get(), await indy.did.getEndpointDid(), myNewDid, myNewVerkey);
    console.log("Connections index-- prepareRequest--aftersendNym myNewDid-->", myNewDid);
    console.log("Connections index-- prepareRequest--aftersendNym myNewVerkey-->", myNewVerkey);
    let nonce = uuid();
    console.log("Connections index-- prepareRequest--aftersendNym nonce-->", nonce);
