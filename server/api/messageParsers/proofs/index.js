...
exports.request = async function (message) {
    ...
    console.log("messageParsers Proofs Index theirDid------>", theirDid);
    console.log("messageParsers Proofs Index name------>", name);
    console.log("messageParsers Proofs Index getTheirEndpointDid endpointDid------>", endpointDid);
    message.links = [
        {
            name: "Accept",
